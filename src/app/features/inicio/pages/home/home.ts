...
export class Home {
  ...
  resumoSobre: string[] = [
    ...
    'Tenho vivência com sistemas legados, manutenção evolutiva, acessibilidade e componentização, com foco em criar produtos mais consistentes e agradáveis de usar.',
  ];

  tecnologiasResumo: string[] = [
    'Angular',
    'TypeScript',
    'SCSS',
    'Acessibilidade',
